CREATE TYPE "public"."job_listings_experience_level" AS ENUM('draft', 'published', 'delisted');--> statement-breakpoint
...
CREATE TABLE "job_listing_application" (
	...
	"createdAt" timestamp with time zone DEFAULT now() NOT NULL,
	"updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "job_listing_application_jobListingId_userId_pk" PRIMARY KEY("jobListingId","userId")
);
--> statement-breakpoint
...
ALTER TABLE "job_listing_application" ADD CONSTRAINT "job_listing_application_jobListingId_job_listings_id_fk" FOREIGN KEY ("jobListingId") REFERENCES "public"."job_listings"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "job_listing_application" ADD CONSTRAINT "job_listing_application_userId_users_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
